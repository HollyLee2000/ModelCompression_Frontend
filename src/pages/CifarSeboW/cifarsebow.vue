      ...
      <el-main style="background-color: white" v-loading="resultLoading">
        ...
        <div class="holly-detect">
          <el-select v-model="chosenModel" placeholder="请选择神经网络模型" size="large">
            <el-option key="6" label="SearchSpaceModel" value="SearchSpaceModel" />
            <el-option key="6" label="NeuralDecisionTree" value="NeuralDecisionTree" />
          </el-select>
          <el-select  v-model="chosenAlgorithm" placeholder="请选择推理算法" size="large">
            <el-option key="6" label="Distributed Inference" value="DI" />
            <el-option key="6" label="Single Path Inference" value="SPI" />
          </el-select>
...
<!--        </div>-->
        ...
        <div style="background-color: #E7E7E7; width:94%; padding: 20px; margin: 0 20px 0 0; border:2px solid #a1a1a1; border-radius:25px;">
          ...
          <div style="margin: 20px 0 20px 0; text-align: center;">
            <label style="font-size:35px; color: black; border: 0; ">4. Search Process</label>
          </div>
          <!--        <div style="margin: 20px 0 20px 0;">-->
          <!--          <label style="font-size:40px; color: white; border: 0; margin: 0 0 0 460px; font-family: 'FZShuTi'">归因图</label>-->
          <!--        </div>-->
...
<!--        </div>-->
<!--&lt;!&ndash;        <div style="margin: 20px 0 20px 0;">&ndash;&gt;-->
<!--&lt;!&ndash;          <label style="font-size:40px; color: white; border: 0; margin: 0 0 0 460px; font-family: 'FZShuTi'">归因图</label>&ndash;&gt;-->
<!--&lt;!&ndash;        </div>&ndash;&gt;-->

<!--&lt;!&ndash;        <el-input&ndash;&gt;-->
<!--&lt;!&ndash;            :placeholder="GroundTruth"&ndash;&gt;-->
<!--&lt;!&ndash;            v-model="input"&ndash;&gt;-->
<!--&lt;!&ndash;            :disabled="true">&ndash;&gt;-->
<!--&lt;!&ndash;        </el-input>&ndash;&gt;-->
<!--&lt;!&ndash;        <el-input&ndash;&gt;-->
<!--&lt;!&ndash;            :placeholder="Predicted"&ndash;&gt;-->
<!--&lt;!&ndash;            v-model="input"&ndash;&gt;-->
<!--&lt;!&ndash;            :disabled="true">&ndash;&gt;-->
<!--&lt;!&ndash;        </el-input>&ndash;&gt;-->
<!--&lt;!&ndash;        <el-input&ndash;&gt;-->
<!--&lt;!&ndash;            :placeholder="Probability"&ndash;&gt;-->
<!--&lt;!&ndash;            v-model="input"&ndash;&gt;-->
<!--&lt;!&ndash;            :disabled="true">&ndash;&gt;-->
<!--&lt;!&ndash;        </el-input>&ndash;&gt;-->
...
async function getImgPoolInfos(option){
  let requestUrl = "/dataset/" + option, requestData = {};
  requestData["datasetId"] = 10001; //其实用不上
  console.log("cifar请求图像指令：", requestUrl)
  await request.post(requestUrl, requestData)
      .then((res) => {
        console.log(res.data);
