<template style="text-align: center">
  <div class="datasetPreview" v-loading="resultLoading">
    <div v-if='ispreview' style="text-align: center">
      <h1 style="margin-top: 20px">Other Popular Vision Benchmarks</h1>
      <div class="previewer" style="margin-bottom: 30px">
        <el-row>
          <el-col :span="4"/>
          <el-col :span="16">
            <el-row class="demo-image">
              <el-col :span="6" v-for="(item,index) in CifarList" class="blockpublic">
                <el-image
                    style="width: 80%; height: 80%; margin-top: 40px;"
                    :fit="'fill'"
                    :initial-index="index"
                    :preview-src-list="CifarList.map(x=>'http://'+x)"
                    :src="`http://${item}`"
                />
              </el-col>
              <el-col :span="6" class="blockpublic">
                ...
                <span>CIFAR</span>
                <br>
                <el-button class="lookdata" @click="checkOut(10001)" type="warning" plain>Data Details</el-button>
                <br>
                <el-button class="dataintro" @click="showDialog" type="success" plain>Introduction</el-button>
...
<!--                &lt;!&ndash;                <br>&ndash;&gt;-->
<!--                &lt;!&ndash;                <el-button class="lookdata" @click="checkOut(10002)" type="success" plain>查看数据集</el-button>&ndash;&gt;-->
<!--                <br>-->
...
<!--      </div>-->
      ...
      <div class="previewer" style="margin-bottom: 30px">
        <el-row>
          ...
          <el-col :span="16">
            <el-row class="demo-image">
              <el-col :span="6" v-for="(item,index) in vocList" class="blockpublic">
                <el-image
                    style="width: 80%; height: 80%; margin-top: 40px;"
                    :fit="'fill'"
                    :initial-index="index"
                    :preview-src-list="vocList.map(x=>'http://'+x)"
                    :src="`http://${item}`"
                />
              </el-col>
              <el-col :span="6" class="blockpublic">
                ...
                <span>VOC</span>
                <br>
                <el-button class="lookdata" @click="checkOut(10003)" type="warning" plain>Data Details</el-button>
                <!--                <br>-->
                <!--                <el-button class="lookdata" @click="checkOut(10003)" type="success" plain>查看数据集</el-button>-->
                <br>
                <el-button class="dataintro" @click="showDialog3" type="success" plain>Introduction</el-button>
                <!--                <el-button class="dataintro" @click="showDialog3" type="warning" plain>数据集介绍</el-button>-->
              </el-col>
            </el-row>
          </el-col>
          <el-col :span="4"/>
      ...
      <div class="previewer" style="margin-bottom: 30px">
        <el-row>
          ...
          <el-col :span="16">
            <el-row class="demo-image">
              <el-col :span="6" v-for="(item,index) in cocoList" class="blockpublic">
                <el-image
                    style="width: 80%; height: 80%; margin-top: 40px;"
                    :fit="'fill'"
                    :initial-index="index"
                    :preview-src-list="cocoList.map(x=>'http://'+x)"
                    :src="`http://${item}`"
                />
              </el-col>
              <el-col :span="6" class="blockpublic">
                ...
                <span>COCO</span>
                <br>
                <el-button class="lookdata" @click="checkOut(10004)" type="warning" plain>Data Details</el-button>
                <!--                <br>-->
                <!--                <el-button class="lookdata" @click="checkOut(10004)" type="success" plain>查看数据集</el-button>-->
                <br>
                <el-button class="dataintro" @click="showDialog4" type="success" plain>Introduction</el-button>
                <!--                <el-button class="dataintro" @click="showDialog4" type="warning" plain>数据集介绍</el-button>-->
              </el-col>
            </el-row>
          </el-col>
          <el-col :span="4"/>
      ...
      <div class="previewer" style="margin-bottom: 30px">
        <el-row>
          ...
          <el-col :span="16">
            <el-row class="demo-image">
              <el-col :span="6" v-for="(item,index) in cubList" class="blockpublic">
                <el-image
                    style="width: 80%; height: 80%; margin-top: 40px;"
                    :fit="'fill'"
                    :initial-index="index"
                    :preview-src-list="cubList.map(x=>'http://'+x)"
                    :src="`http://${item}`"
                />
              </el-col>
              <el-col :span="6" class="blockpublic">
                ...
                <span>CUB</span>
                <br>
                <el-button class="lookdata" @click="checkOut(10005)" type="warning" plain>Data Details</el-button>
                <!--                <br>-->
                <!--                <el-button class="lookdata" @click="checkOut(10005)" type="success" plain>查看数据集</el-button>-->
                <br>
                <el-button class="dataintro" @click="showDialog5" type="success" plain>Introduction</el-button>
                <!--                <el-button class="dataintro" @click="showDialog5" type="warning" plain>数据集介绍</el-button>-->
              </el-col>
            </el-row>
          </el-col>
          <el-col :span="4"/>
      ...
      <div class="previewer" style="margin-bottom: 30px">
        <el-row>
          ...
          <el-col :span="16">
            <el-row class="demo-image">
              <el-col :span="6" v-for="(item,index) in carList" class="blockpublic">
                <el-image
                    style="width: 80%; height: 80%; margin-top: 40px;"
                    :fit="'fill'"
                    :initial-index="index"
                    :preview-src-list="carList.map(x=>'http://'+x)"
                    :src="`http://${item}`"
                />
              </el-col>
              <el-col :span="6" class="blockpublic">
                ...
                <span>CARS</span>
                <br>
                <el-button class="lookdata" @click="checkOut(10006)" type="warning" plain>Data Details</el-button>
                <!--                <br>-->
                <!--                <el-button class="lookdata" @click="checkOut(10006)" type="success" plain>查看数据集</el-button>-->
                <br>
                <el-button class="dataintro" @click="showDialog6" type="success" plain>Introduction</el-button>
                <!--                <el-button class="dataintro" @click="showDialog6" type="warning" plain>数据集介绍</el-button>-->
              </el-col>
            </el-row>
          </el-col>
          <el-col :span="4"/>
...
const fileList = ref(['pruning.vipazoo.cn/api/Cifar/0_1740.jpg','pruning.vipazoo.cn/api/Cifar/3_10557.jpg','pruning.vipazoo.cn/api/Cifar/7_18534.jpg',
  ...
  'pruning.vipazoo.cn/api/CARS/00009.jpg','pruning.vipazoo.cn/api/CARS/00082.jpg','pruning.vipazoo.cn/api/CARS/00246.jpg']);
