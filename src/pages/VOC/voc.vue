<template>
  <div class="history">
    <h1 style="color: black; font-size: xx-large">Submission Histories</h1>
    <!--    height="100"-->
    <!--    max-height="100"-->
    <el-table
        :data="tableData"
    ...
    >
      ...
      <el-table-column min-width="140" fixed prop="username" label="user name" />
      <el-table-column min-width="140" prop="institute" label="institute" />
      ...
      <el-table-column min-width="140" prop="name" label="algorithm name">
        <template #default="props">
          <text v-if="props.row.morfPath==='leaderboard'">{{props.row.name}}</text>
          <text v-else>N/A</text>
        </template>
      </el-table-column>
      <el-table-column min-width="140" prop="lerfPath" label="algorithm type">
        <template #default="props">
...
<!--      <el-table-column min-width="100" prop="ranking" label="ranking" sortable="sortable" />-->
      ...
      <el-table-column min-width="140" prop="dateTime" label="Submit Time" sortable="sortable"  />
      ...
      <el-table-column label="Status" min-width="160">
        <template #default="props">
          <div v-if="props.row.status==='In Process'&&props.row.morfPath!=='suggestion'">
          ...
          <div v-else>
            <el-text class="mx-1" type="success" style="color: #4C4C4C; font-weight: bold">N/A</el-text>
          </div>
...
function getTableData(){
  request.post('/history/findHistoryByUserNew',{
