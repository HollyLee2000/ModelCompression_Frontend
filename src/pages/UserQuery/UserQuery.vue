...
<!--        </div>-->
    ...
    <el-main style="background-color: white" v-loading="resultLoading">
      ...
      <div class="holly-detect-3-answer">
        ...
        <el-input class="special" v-model="userQuery" placeholder="请输入你想问的问题(英语)" style="width:200px;"/>
      ...
      <div style="margin: 20px 0 20px 0; text-align: center;">
        <label style="font-size:35px; border: 0; color: black; ">3. Answers and Attribution Results</label>
      </div>
      <div style="display: flex; justify-content: center;">
        <div v-for="(item,index) in showListre" style="margin: 30px 0;">
          <el-image :src="`http://${item}`"
                    :fit="'fill'"
                    :preview-src-list="listPreviewre"
                    :initial-index="index"
          >
          </el-image>
        </div>
      ...
      <div style="display: flex; justify-content: center;">
        <div v-for="(item,index) in showList2re" style="margin: 30px 0;">
          <el-image :src="`http://${item}`"
                    :fit="'fill'"
                    :preview-src-list="listPreview2re"
                    :initial-index="index"
          >
          </el-image>
        </div>
...
<!--        <label style="font-size:40px; color: white; border: 0; margin: 0 0 0 400px; font-family: 'FZShuTi'">回答与归因结果</label>-->
<!--      </div>-->
<!--      <el-row style="margin: 30px 0 0 0px; text-align: center;">-->
<!--        <el-col v-for="(item,index) in showListre" :span="24" :key="index">-->
...
<!--      </el-row>-->
<!--      <el-row style="margin: 30px 0 0 0px; text-align: center;">-->
<!--        <el-col v-for="(item,index) in showList2re" :span="24" :key="index">-->
<!--          &lt;!&ndash;                  <div :id=item.id :class="istrue?'block3':'block2'" @click="istrue=!istrue">&ndash;&gt;-->
<!--          <el-image :src="`http://${item}`"-->
<!--                    :preview-src-list="listPreview2re"-->
<!--                    :initial-index="index"-->
...
<!--      </el-row>-->
      ...
      <div style="margin: 0 0 20px 0; text-align: center;">
        <label style="font-size:35px; border: 0; color: black; ">4. Contribution Scores</label>
      </div>
      <div style="background-color: #E7E7E7; width:94%; padding: 20px; margin: 0 20px 0 0; border:2px solid #a1a1a1; border-radius:25px;">
        <label style="background-color: #E7E7E7; font-size:30px; color: black; border: 0; font-family: 'Microsoft Yahei'">Text Contributions: </label>
        <label style="background-color: #E7E7E7; font-size:30px; color: #C40000; border: 0; font-family: 'Microsoft Yahei'">{{GroundTruth}}</label>
        <br>
        <label style="background-color: #E7E7E7; font-size:30px; color: black; border: 0; font-family: 'Microsoft Yahei'">Image Contributions: </label>
        <label style="background-color: #E7E7E7; font-size:30px; color: #C40000; border: 0; font-family: 'Microsoft Yahei'">{{Predicted}}</label>
        <br>
        <label style="background-color: #E7E7E7; font-size:30px; color: black; border: 0; font-family: 'Microsoft Yahei'">Total Contribution: </label>
...
<!--        <label style="font-size:40px; color: white; border: 0; margin: 0 0 0 440px; font-family: 'FZShuTi'">贡献分数</label>-->
<!--      </div>-->
<!--      <div style="background-color: #6C6CFF; width:96%; padding: 20px; margin: 0 20px 0 0; border:2px solid #a1a1a1; border-radius:25px;">-->
<!--        <label style="background-color: #6C6CFF; font-size:30px; color: white; border: 0; font-family: 'Microsoft Yahei'">Text Contributions: </label>-->
<!--        <label style="background-color: #6C6CFF; font-size:30px; color: #C40000; border: 0; font-family: 'Microsoft Yahei'">{{GroundTruth}}</label>-->
<!--        <br>-->
<!--        <label style="background-color: #6C6CFF; font-size:30px; color: white; border: 0; font-family: 'Microsoft Yahei'">Image Contributions: </label>-->
<!--        <label style="background-color: #6C6CFF; font-size:30px; color: #C40000; border: 0; font-family: 'Microsoft Yahei'">{{Predicted}}</label>-->
<!--        <br>-->
<!--        <label style="background-color: #6C6CFF; font-size:30px; color: white; border: 0; font-family: 'Microsoft Yahei'">Total Contribution: </label>-->
...
<!--        <el-col v-for="(item,index) in showList" :span="12" :key="index">-->
<!--          &lt;!&ndash;                  <div :id=item.id :class="istrue?'block3':'block2'" @click="istrue=!istrue">&ndash;&gt;-->
<!--          <el-image :src="`http://${item}`"-->
...
const showList = ref([]), showList2 = ref([]), pictureShowList=ref([]);
...
const showListre = ref([]), showList2re = ref([]), listPreviewre = ref([]), listPreview2re = ref([]);
